...
::: {.mu-meta}
**Estado:** nota técnica en desarrollo.  
...
::: {.mu-card-thumb}
::: {.exchange-thumb-card}
<strong>FX · 10Y · LatAm</strong>
<span>residuos interactivos</span>
::: 
:::
::: {.mu-card-kicker}
Macrofinanzas regionales
:::
### Tipo de cambio, tasas largas y riesgo soberano en LatAm

Modelos diarios para CLP, BRL, MXN, PEN y COP que comparan movimientos del tipo de cambio y tasas soberanas 10Y frente a fundamentos externos y riesgo soberano medido con EMBIG país.

::: {.mu-meta}
**Estado:** proyecto aplicado integrado al sitio, con dashboard interactivo desde datos procesados.  
**Herramientas:** R, tidyverse, plotly, BIS, FRED, BCCh y BCRPData.
:::
...
Diseño de gráficos económicos que comuniquen resultados macroeconómicos sin sobrecargar la lectura ni esconder supuestos relevantes.
:::
