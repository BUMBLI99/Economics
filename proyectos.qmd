...
Simulación condicional en Matlab/IRIS: escenario base IPoM identificado y alternativa con TPM en 4,5% durante 2026, retornando a la trayectoria base desde 2027.
...
::: {.mu-card}
::: {.mu-card-thumb}
![Stress macrofinanciero LatAm](assets/img/exchange/fx_residuals_zscores_from2018.jpg)
:::
::: {.mu-card-kicker}
...
Modelos diarios para CLP, BRL, MXN, PEN y COP que comparan movimientos del tipo de cambio y tasas soberanas 10Y respecto de fundamentos externos observables.
